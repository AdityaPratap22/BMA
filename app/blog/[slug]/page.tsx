            ...
            <div className="lg:col-span-8 space-y-8">
              <div className="bg-white border border-[#E7E0D6] rounded-3xl p-6 sm:p-10 shadow-warm-sm">
                ...
                <div className="mt-12 p-8 rounded-2xl bg-[#F7F3ED] border border-[#9A481B]/40 shadow-sm flex flex-col sm:flex-row items-center justify-between gap-6">
                  ...
                  <a
                    href="https://wa.me/918586989832?text=Hi%2C%20I%20would%20like%20to%20discuss%20the%20strategy%20playbook%20for%20my%20business"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="px-6 py-3 bg-[#25D366] hover:bg-[#20ba5a] text-white rounded-xl text-xs font-bold transition shadow-sm whitespace-nowrap inline-flex items-center gap-2 shrink-0 group"
                  >
                    <svg
                      className="w-4 h-4 fill-white transition-transform group-hover:scale-110"
                      viewBox="0 0 16 16"
