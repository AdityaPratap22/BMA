      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
        ...
        <div className="relative bg-white border border-stone-200 rounded-4xl p-8 sm:p-14 shadow-warm-md space-y-6 overflow-hidden">
          ...
          <div className="flex flex-wrap items-center gap-4 pt-2">
            ...
            <a
              href={`https://wa.me/918586989832?text=Hi%2C%20I%20would%20like%20to%20discuss%20a%20marketing%20strategy%20for%20${encodeURIComponent(cityName)}`}
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2.5 bg-[#25D366] hover:bg-[#20ba5a] text-white px-8 py-4 rounded-full font-bold text-sm sm:text-base transition-all shadow-warm-sm group"
            >
              <svg
